...
public class Main {
    ...
    private static Album.SongList songListObject = albumObject.new SongList();
    ...
    //Song newAlbum = Song.songConstructor(albumName, newSong);
    songListObject.addAlbum(newSong,albumName);
    System.out.println("Press 0 to see main menu.");
}
